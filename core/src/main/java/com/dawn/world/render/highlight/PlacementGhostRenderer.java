...
public final class PlacementGhostRenderer {
    ...
    public void render(SpriteBatch batch, DawnAssets assets, List<PlacementPreview> previews) {
        for (PlacementPreview preview : previews) {
            if (preview instanceof PlacementPreview.FloorCell floor) {
                ...
                BlockSpriteDraw.drawTintedCell(batch, assets, floor.cellX(), floor.cellY(), tint);
                ...
                if (visual != null) {
                    BlockSpriteDraw.drawTintedBlock(batch, assets, visual, block.cellX(), block.cellY(), tint);
                }
                ...
                structureMasks.renderSprites(batch, sprites, tint);
            }
        }
    }
}
